    ...
    <div className="group bg-zinc-900 relative h-[12vw]">
      <div className="relative w-full h-full cursor-pointer">
        <Image
          ...
          src={data.thumbnailUrl || '/fallback.png'}
          alt={data.title || 'Movie'}
          draggable={false}
          fill
          style={{ objectFit: 'cover', borderRadius: '0.375rem' }}
          className="transition duration-300 group-hover:opacity-90 sm:group-hover:opacity-0"
        />
      </div>

      <div className="opacity-0 absolute top-0 w-full h-full transition duration-200 z-10 invisible sm:visible scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
        <div className="relative w-full h-full">
          <Image
            ...
            className="transition duration-300 shadow-xl"
          />
        </div>
